...
public static class TileUtils
{
    ...
    /// <returns>The tile location of the multitile's top-left corner,
    /// or the input location if no tile is present or the tile is not part of a multitile</returns>
    ...
    /// <returns><see langword="true"/> if there was a <typeparamref name="T"/> instance, or <see langword="false"/>
    /// if there was no entity present OR the entity was not a <typeparamref name="T"/> instance.</returns>
